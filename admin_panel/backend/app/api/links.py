...
from app.models.shared import CrosspostingLink, TelegramChannel, MaxChannel, User
...
@limiter.limit("60/1minute")
async def get_link(
    request: Request, link_id: int, current_admin: Admin = Depends(get_current_admin), db: AsyncSession = Depends(get_db)
):
