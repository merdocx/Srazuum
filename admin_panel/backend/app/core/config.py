...
class Settings(BaseSettings):
    ...
    # Security
    secret_key: str = "change-this-secret-key-in-production-use-random-string-min-32-chars"
    algorithm: str = "HS256"
    ...
    # CORS
    cors_origins: List[str] = ["http://localhost:3000", "http://192.144.59.128", "http://srazuum.ru", "https://srazuum.ru"]
