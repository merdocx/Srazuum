    ...
    async with async_session_maker() as session:
        ...
        try:
            ...
            answer_text = (
                ...
                f"📄 <a href='http://192.144.59.128:8001/docs/privacy_policy.html'>Политика конфиденциальности</a>\n"
                f"📄 <a href='http://192.144.59.128:8001/docs/terms_of_service.html'>Пользовательское соглашение</a>"
            )
